...
TIMELINE_CHANGES = [
	...
	},
	{
		...
		INVERTED: [
			(0, 0), (1, 1), (3, 0), (4, 1), (11, 0), (2 ** 32 - 1, 1)
		]
	},
	{
		INPUT: (13, 15),
		OUTPUT: [
			(1, 0), (3, 1), (4, 0), (11, 1), (13, 0), (15, 1)
		],
		INVERTED: [
			(0, 0), (1, 1), (3, 0), (4, 1), (11, 0), (13, 1), (15, 0), (2 ** 32 - 1, 1)
		]
	},
	{
		INPUT: (15, 16),
		OUTPUT: [
			(1, 0), (3, 1), (4, 0), (11, 1), (13, 0), (16, 1)
		],
		INVERTED: [
			(0, 0), (1, 1), (3, 0), (4, 1), (11, 0), (13, 1), (16, 0), (2 ** 32 - 1, 1)
		]
	},
	{
		INPUT: (11, 13),
...
class TimelineFilterTest(unittest.TestCase):
	...
	def test_addTimeRange_convert_success(self):
		...
		self.assertListEqual(self.timeline.timeline, [
			(3, 0), (12, 1)
		])
		...
		self.assertListEqual(self.timeline.timeline, [
			(3, 0), (12, 1), (854668800, 0), (946616410, 1)
		])
